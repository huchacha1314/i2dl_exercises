...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        layer1_out, cache_affine1 = affine_forward(X, W1, b1)
        layer1_sig, cache_sigmoid = sigmoid_forward(layer1_out)
        y, cache_affine2 = affine_forward(layer1_sig, W2, b2)
    ...
    def backward(self, dy):
        ...
        dx, dW2, db2 = affine_backward(dy, cache_affine2)
        dSig = sigmoid_backward(dx, cache_sigmoid)
        _, dW1, db1 = affine_backward(dSig, cache_affine1)
